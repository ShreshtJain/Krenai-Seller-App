 ...
 */
class customerCreditFragment(val creditBookUrl:String): Fragment() {
    ...
    override fun onCreateView(
        ...
        val View=inflater.inflate(R.layout.fragment_customer_credit, container, false)
        ...
        Log.i("credit wallet url",creditBookUrl)
        creditData()
    ...
    fun creditData()
    {
        ...
        val jsonObjectRequest = object : JsonObjectRequest(
            Request.Method.GET, creditBookUrl,
                        ...
                        for (i in 0 until data.length()) {
                            ...
                            arrayList.add(
                                DataCreditModel(Object.getString("id")
                                    ...
                                    Object.getString("userRequestAmount"),Object.getString("balancePoint"))
                            )
