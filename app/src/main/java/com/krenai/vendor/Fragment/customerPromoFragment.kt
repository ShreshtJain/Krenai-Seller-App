 ...
 */
class customerPromoFragment(val promoWalletUrl:String) : Fragment() {
    ...
    override fun onCreateView(
        ...
        val View=inflater.inflate(R.layout.fragment_customer_promo, container, false)
        ...
        Log.i("promo wallet url",promoWalletUrl)
        promoData()
    ...
    fun promoData()
    {
        ...
        val jsonObjectRequest = object : JsonObjectRequest(
            Request.Method.GET, promoWalletUrl,
            Response.Listener<JSONObject>() { response ->
                ...
                try {
                    ...
                    for (i in 0 until data.length()) {
                        ...
                        arrayList.add(DataCreditModel(Object.getString("id")
