...
import com.krenai.vendor.utils.jkeys.Keys.Home.DATA_PATH_SALES_BY_PRODUCT_REPORT
import org.json.JSONException
import org.json.JSONObject
import java.text.SimpleDateFormat
import java.util.*

class SalesByProduct : AppCompatActivity() {
    ...
    var url=CONNECTION_URL_DEMAND+DATA_PATH_SALES_BY_PRODUCT_REPORT+"?sortBy=createdDate&sortOrder=Desc&"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_sales_by_product)
    ...
    fun setupRecycler()
    {
        val list= arrayListOf<DataSalesByProduct>()
        ...
        val url1=url+startdate+enddate+"&stateId=0&supplierId="+userid?.toDouble()?.toInt().toString()
        Log.i("url1",url1)
            ...
            Response.Listener<JSONObject>() { response ->
                ...
                try {
                    ...
                    for (i in 0 until data.length())
                    {
                        ...
                        val model= DataSalesByProduct(Object.getString("date"),Object.getString("imageUrl"),
                            Object.getString("productName"),Object.getString("categoryName"),Object.getString("subCategoryName"),
                            Object.getString("subSubCategoryName"),Object.getString("noOfSoldQuantity"),Object.getString("skuCode"),
                            Object.getString("sellingPrice"),Object.getString("netSale"),Object.getString("totalSale"))
                        list.add(model)
                    }
                    ...
                    val Adapter =
                       SalesByProductAdapter(this, list)
