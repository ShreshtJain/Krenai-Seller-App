...
import com.krenai.vendor.Adapter.SalesAvgOrderAdapter
...
import com.krenai.vendor.utils.jkeys.Keys.Home.DATA_PATH_AVG_ORDERS
import org.json.JSONException
import org.json.JSONObject
import java.text.SimpleDateFormat
import java.util.*

class AvgOrder : AppCompatActivity() {
    ...
    var url=CONNECTION_URL+DATA_PATH_AVG_ORDERS+"?sortBy=createdDate&sortOrder=Desc&"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_avg_order)
            ...
            Response.Listener<JSONObject>() { response ->
                ...
                try {
                    ...
                    for (i in 0 until data.length())
                    {
                        ...
                        if(Object.getString("averageOrder")!="NaN") {
                            bar_list.add(Object.getString("averageOrder").toFloat())
                        }
                        else
                        {
                            bar_list.add("0".toFloat())
                        }
                    ...
                    val barDataSet1 = BarDataSet(entries1, "Average Order")
                    ...
                    val Adapter =
                        SalesAvgOrderAdapter(this, list)
