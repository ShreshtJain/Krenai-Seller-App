...
class ProductsListingImageAdapter( val itemList: ProductModel) :
    RecyclerView.Adapter<ProductsListingImageAdapter.ProductsListingImageViewHolder>() {
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): ProductsListingImageAdapter.ProductsListingImageViewHolder {
    ...
    override fun onBindViewHolder(
        holder: ProductsListingImageAdapter.ProductsListingImageViewHolder,
        position: Int
    ) {
