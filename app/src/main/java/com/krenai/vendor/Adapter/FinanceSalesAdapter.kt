...
class FinanceSalesAdapter(val context: Context?, val itemList: ArrayList<DataFinanceSales>) :
    RecyclerView.Adapter<FinanceSalesAdapter.FinanceSalesViewHolder>() {
    private val viewPool = RecyclerView.RecycledViewPool()
    private var sharedPreferencesStatus: SharedPreferences? = null
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): FinanceSalesAdapter.FinanceSalesViewHolder {
        val itemView = LayoutInflater.from(parent.context)
            .inflate(R.layout.finance_sales_custom_row, parent, false)
    ...
    override fun onBindViewHolder(
        holder: FinanceSalesAdapter.FinanceSalesViewHolder,
        position: Int
    ) {
